  ...
  head: () => ({
    meta: [
      ...
      { title: "ReguLens — EU AI Act compliance triage" },
      {
        name: "description",
        content:
          "Multi-agent EU AI Act (Regulation 2024/1689) assessment for AI use-cases.",
      },
      { property: "og:title", content: "ReguLens" },
      {
        property: "og:description",
        content:
          "Multi-agent EU AI Act assessment for AI use-cases.",
      },
